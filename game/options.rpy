...
define config.main_menu_music = "audio/Rings Of Power - Khazad Dum.mp3"
...
define config.save_directory = "Vsederron-1711003275"
...
init python:
    ...
    renpy.music.register_channel("back_phrase", loop=False)
