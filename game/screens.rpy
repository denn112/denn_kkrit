...
screen navigation():
    ...
    vbox:
        ...
        if main_menu:
            ...
            textbutton _("Начать") action Start() hover_sound "hover_sound.mp3"

        else:

            textbutton _("История") action ShowMenu("history") hover_sound "hover_sound.mp3"

            textbutton _("Сохранить") action ShowMenu("save") hover_sound "hover_sound.mp3"

        textbutton _("Загрузить") action ShowMenu("load") hover_sound "hover_sound.mp3"

        textbutton _("Авто") action Preference("auto-forward", "toggle") hover_sound "hover_sound.mp3"

        textbutton _("Пропуск") action Skip() alternate Skip(fast=True, confirm=True) hover_sound "hover_sound.mp3"

        textbutton _("Настройки") action ShowMenu("preferences") hover_sound "hover_sound.mp3"

        if _in_replay:

            textbutton _("Завершить повтор") action EndReplay(confirm=True) hover_sound "hover_sound.mp3"

        elif not main_menu:

            textbutton _("Главное меню") action MainMenu() hover_sound "hover_sound.mp3"
        ...
        if renpy.variant("pc") or (renpy.variant("web") and not renpy.variant("mobile")):
            ...
            textbutton _("Помощь") action ShowMenu("help") hover_sound "hover_sound.mp3"

        if renpy.variant("pc"):

            ## Кнопка выхода блокирована в iOS и не нужна на Android и в веб-
            ## версии.
            textbutton _("Выход") action Quit(confirm=not main_menu) hover_sound "hover_sound.mp3"
...
screen game_menu(title, scroll=None, yinitial=0.0, spacing=0):
    ...
    textbutton _("Вернуться"):
        ...
        action Return() hover_sound "hover_sound.mp3"
        ...
        fixed:
            ...
            grid gui.file_slot_cols gui.file_slot_rows:
                ...
                for i in range(gui.file_slot_cols * gui.file_slot_rows):
                    ...
                    button:
                        action FileAction(slot) hover_sound "hover_sound.mp3"
            ...
            vbox:
                ...
                hbox:
                    ...
                    textbutton _("<") action FilePagePrevious() hover_sound "hover_sound.mp3"

                    if config.has_autosave:
                        textbutton _("{#auto_page}А") action FilePage("auto") hover_sound "hover_sound.mp3"

                    if config.has_quicksave:
                        textbutton _("{#quick_page}Б") action FilePage("quick") hover_sound "hover_sound.mp3"

                    ## range(1, 10) задаёт диапазон значений от 1 до 9.
                    for page in range(1, 10):
                        textbutton "[page]" action FilePage(page) hover_sound "hover_sound.mp3"

                    textbutton _(">") action FilePageNext() hover_sound "hover_sound.mp3"
            ...
            hbox:
                ...
                if renpy.variant("pc") or renpy.variant("web"):
                    ...
                    vbox:
                        ...
                        textbutton _("Оконный") action Preference("display", "window") hover_sound "hover_sound.mp3"
                        textbutton _("Полный") action Preference("display", "fullscreen") hover_sound "hover_sound.mp3"

                vbox:
                    style_prefix "check"
                    label _("Пропуск")
                    textbutton _("Всего текста") action Preference("skip", "toggle") hover_sound "hover_sound.mp3"
                    textbutton _("После выборов") action Preference("after choices", "toggle") hover_sound "hover_sound.mp3"
                    textbutton _("Переходов") action InvertSelected(Preference("transitions", "toggle")) hover_sound "hover_sound.mp3"
                ...
                vbox:
                    ...
                    if config.has_music or config.has_sound or config.has_voice:
                        ...
                        textbutton _("Без звука"):
                            action Preference("all mute", "toggle") hover_sound "hover_sound.mp3"
    ...
    use game_menu(_("Помощь"), scroll="viewport"):
        ...
        vbox:
            ...
            hbox:
                ...
                textbutton _("Клавиатура") action SetScreenVariable("device", "keyboard") hover_sound "hover_sound.mp3"
                textbutton _("Мышь") action SetScreenVariable("device", "mouse") hover_sound "hover_sound.mp3"
